...
class TourController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $to=TransactionAccount::where('id', $sale->ledger)->value('Trans_Acc_Name');
        $enter_by=User::where('id', $sale->created_by)->value('name');
        $result=Ticket::where('SID', $id)->get();
        $hotels=LeadHotel::with('hotel_name')->where('SID', $id)->get();
        $visa=Visa::with('country')->where('SID', $id)->get();
        $transports=Transport::where('SID', $id)->get();
        $others=OtherSale::where('SID', $id)->get();
        return view('Lms.sales.prints.tour',compact('result','hotels','visa','transports',
        'others','sale','to','enter_by'));
    }
