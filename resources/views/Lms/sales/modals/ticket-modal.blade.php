                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input name="fourtnite" class="form-control form-control-sm date" placeholder="Fortnite Date" value="{{ \App\Helpers\CommonHelper::current_date() }}">
                        </div>
                        <!--col-->
                        <div class="form-group col-md-2">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input name="mobile" class="form-control form-control-sm" placeholder="Mobile" value="{{ $result[0]->mobile }}">
                        </div>
                        <!--col-->
                        <div class="form-group col-md-2">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" name="departure_date" class="form-control form-control-sm date" placeholder="Departure Date" value="{{ \App\Helpers\CommonHelper::current_date() }}">
                        </div>
                        <!--col-->
                        <div class="form-group col-md-2">
