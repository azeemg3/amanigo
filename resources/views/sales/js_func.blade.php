...
<script type="text/javascript">
    ...
    function get_ticket_invoice(page, srch) {
        $("#loader").show();
        $.ajax({
            url:"{{ url('Sale/get_ticket_inv') }}?page="+page,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
    ...
    function get_hotel_invoice(page, srch) {
        $("#loader").show();
        $.ajax({
            url:"{{ url('Sale/get_hotel_inv') }}?page="+page,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
    ...
    function get_visa_invoice(page, srch) {
        $("#loader").show();
        $.ajax({
            url:"{{ url('Sale/get_visa_inv') }}?page="+page,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
    ...
    function get_transport_invoice(page, srch) {
        $("#loader").show();
        $.ajax({
            url:"{{ url('Sale/get_transport_inv') }}?page="+page,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
    ...
    function get_other_invoice(page, srch) {
        $("#loader").show();
        $.ajax({
            url:"{{ url('Sale/get_other_inv') }}?page="+page,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
    ...
    function get_tour_invoice(page, srch) {
        $("#loader").show();
        $.ajax({
            url:"{{ url('Sale/get_tour') }}?page="+page,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
...
//                }
    ...
    function get_refunds(page) {
        $("#loader").show();
        $.ajax({
            url:"{{ url('lms/get_refunds') }}?page="+page,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
            success:function (data) {
    ...
    function get_receipts(page){
        $("#loader").show();
        $.ajax({
            url:"{{ url('lms/get_receipts') }}?page="+page,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
            success:function (data) {
...
//        var agent_sec=$(g).closest('form').find('.agent_amount_s').val();
    ...
    function fetch_customer(g, type) {
        $.ajax({
            url:"{{ url('Sale/fetch_customers') }}/"+type,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"GET",
            dataType:"JSON",
            success:function (data) {
