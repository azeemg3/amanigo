        ...
        <tr>
            <td class="esd-email-paddings" valign="top">
                <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                    <tbody>
                    <tr>
                        <td align="center"><img src="https://uotrips.com/uotrips-web/public/images/ur-owntrips-logo.png"> </td>
                    </tr>
                    <tr>
                        <td class="" style="background-color: #ffa73b;" esd-custom-block-id="6340" bgcolor="#ffa73b" align="center">
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="600" valign="top" align="center">
                                                    <table style="background-color: #faa61a; border-radius: 4px; border-collapse: separate;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#faa61a">
                                                        <tbody>
                                                        <tr>
                                                    ...
                                                    <table style="border-radius: 4px; border-collapse: separate; background-color: #ffffff;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left">
                                                                <p>Thanks for giving us a chance to serve you, our committment is your satisfaction.</p>
                                                                <p>For any Travel need , we are always at your kind service and just a click away.</p>
                                                                <h3>Call: <a target="_blank" href="https://api.whatsapp.com/send?phone=923234610468&amp;text=Thank you for contacting uotrips.com">+92 21-35210452</a>  or visit <a target="_blank" href="http://uotrips.com">uotrips.com</a></h3>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="600" valign="top" align="center">
                                                    <table style="background-color: #ffecd1; border-radius: 4px; border-collapse: separate;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffecd1">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p30b es-p30r es-p30l" esdev-links-color="#ffa73b" align="center">
                                                                <a target="_blank" href="http://www.uotrips.com/" style="color: #ffa73b;">We’re here, ready to talk</a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
