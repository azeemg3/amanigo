<?php $__env->startSection("my_title","Create New Lead"); ?>
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Contact Name" class="form-control form-control-sm" name="contact_name" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-2">
                                    <div class="form-group">
                                        <label>Mobile:</label>
                                        <input placeholder="e.g 923244659501" class="form-control form-control-sm" name="mobile" type="text" onchange="check_ex_lead(this.value)">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-2">
                                    <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-2">
                                    <div class="form-group">
                                        <label>ID:</label>
                                        <input placeholder="ID" class="form-control form-control-sm" name="cnic">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-2">
                                    <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm select2" multiple data-placeholder="Select Services" name="services[]">
                                            ...
                                            <?php echo App\Helpers\CommonHelper::services(); ?>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" name="source_of_query">
                                            <?php echo App\Helpers\CommonHelper::query_source(); ?>
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('Lms.ex-lead-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function check_ex_lead(nmbr) {
            $.ajax({
                url:"<?php echo e(url('lms/ex_lead')); ?>/"+nmbr,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"GET",
                dataType:"JSON",
                success:function (data) {
                    if(data.id){
                        $("#ex-lead-modal").modal({backdrop: 'static'});
                    }
                    let htmlData='';
                    htmlData+='<tr>';
                        htmlData+='<td>'+data.id+'</td>';
                        htmlData+='<td>'+data.contact_name+'</td>';
                        htmlData+='<td>'+data.mobile+'</td>';
                        htmlData+='<td>'+lsb(data.status)+'</td>';
                        htmlData+='<td><a href="<?php echo e(url('lms/lead/')); ?>/'+data.id+'"><i class="fa fa-eye"></i></a></td>';
                    htmlData+='</tr>';
                    $("#get_ex_lead").html(htmlData);
                },error:function(ajaxcontent) {
                }
            })
        }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_8.2\htdocs\pp\amani-go\resources\views/Lms/create_lead.blade.php ENDPATH**/ ?>