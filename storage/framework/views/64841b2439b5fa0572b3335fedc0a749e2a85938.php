<?php $__env->startSection("my_title","Takenover Leads"); ?>
<?php $__env->startSection('content'); ?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Takenover Leads</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card-header">
                            <form id="search-form">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" onclick="get_data(1)" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> </button>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        ...
        function get_data(page){
            $("#loader").show()
            $.ajax({
                url:"<?php echo e(url('lms/get_to_leads')); ?>?page="+page,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_8.2\htdocs\pp\amani-go\resources\views/Lms/to_leads.blade.php ENDPATH**/ ?>