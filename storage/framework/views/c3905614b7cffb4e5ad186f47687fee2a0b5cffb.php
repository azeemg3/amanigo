...
<div class="login-box">
    <div class="login-logo">
        <img src="<?php echo e(URL::asset("public/dist/img/logo.png")); ?>" style="width: 80%">
    </div>
    <!-- /.login-logo -->
    <div class="card">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="input-group mb-3">
                    <select class="form-control" name="financial_year">
                        <?php echo App\Models\FinancialYear::dropdown(); ?>
...
<?php /**PATH E:\xampp_8.2\htdocs\pp\amani-go\resources\views/auth/login.blade.php ENDPATH**/ ?>