    ...
    */
    ...
    Route::group(['middleware' => ['auth']], function() {
        Route::prefix('lms')->group(function (){
            ...
            Route::get('reopen_lead/{leadID}', 'LeadController@reopen_lead');
            Route::get('pending_leads', 'LeadController@pending_leads');
            Route::get('to_leads', 'LeadController@to_leads');
            Route::post('get_to_leads', 'LeadController@get_to_leads');
            Route::get('ip_leads', 'LeadController@ip_leads');
            Route::post('get_ip_leads', 'LeadController@get_ip_leads');
            Route::get('sf_leads', 'LeadController@sf_leads');
            Route::post('get_sf_leads', 'LeadController@get_sf_leads');
            Route::get('us_leads', 'LeadController@us_leads');
            Route::post('get_us_leads', 'LeadController@get_us_leads');
            ...
            Route::get('ex_lead/{number}','LeadController@check_ex_lead');
            Route::post('close_lead','LeadController@close_lead');
            Route::post('transfer_lead','LeadController@transfer_lead');
            //@lead sales
            ...
            Route::get('tour/{id}', 'LeadSale\TourController@show');
            //tour visa
